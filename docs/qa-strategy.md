...
| `Werewolves.Client.Tests.Resources.LocalizationPolicyTests.ClientTests_DoNotHardcodeLocalizedProductionCopyOutsideResourceContracts` | Permanent policy | Client tests do not hardcode localized production copy outside resource contract tests. | The client test tree and generated resource files are the contract. |
