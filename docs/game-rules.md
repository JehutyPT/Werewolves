...
### Characters Specific to New Moon (Require New Moon Events)
...
*   **Town Crier:** Designated by the Sheriff. Receives a hand of New Moon Event cards (non-Spiritualism) from the Moderator. Each morning, may choose to play one card, reading it aloud as a public announcement. The Sheriff can replace the Town Crier. Requires New Moon Event cards.
