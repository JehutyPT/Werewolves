...
- Cupid links the selected pair at its ordinary early Night 1 call. If their **Faction Beneficiaries** differ at that moment, both become **Cross-Faction Lovers**, whose win condition is being the last two Players alive.
...
- When Actor selects Cupid, the Lovers' Faction relationship is determined from their Faction Beneficiaries at the moment they are linked.
