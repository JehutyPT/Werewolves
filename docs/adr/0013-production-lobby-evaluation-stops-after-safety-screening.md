...
Production lobby evaluation uses the `DegenerateScreeningOnly` capability. It retains the deterministic Already-Decided Role Composition gate and the 1,000-run Degenerate Simulation Scenario gate, then stops before the 10,000-run probability batch.
