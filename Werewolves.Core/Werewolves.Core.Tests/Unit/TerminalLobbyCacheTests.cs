...
public class TerminalLobbyCacheTests
{
	...
	public static IEnumerable<object[]> InvalidSinglePayloads()
	{
		...
		yield return [AlreadyGolden.Replace("safety-screening@12", "safety screening@12", StringComparison.Ordinal)];
		yield return [AlreadyGolden.Replace("safety-screening@12", "safety-screening@11", StringComparison.Ordinal)];
	...
	public void ReadDocument_ValidatesCurrentMixedRecordsAgainstEachRecordsProducer()
	{
		...
		read.Document!.Records.Select(record => record.CompatibilityIdentity.Profile.ToString())
			.Should().Equal("full-probability@3", "safety-screening@12", "safety-screening@12");
	}
	...
	[Theory]
	[InlineData(false, "safety-screening@12", "safety-screening@11")]
	[InlineData(true, "full-probability@3", "full-probability@2")]
	[InlineData(false, "safety-screening@12", "foreign-simulator@1")]
	[InlineData(false, "safety-screening@12", "core-simulator@1")]
