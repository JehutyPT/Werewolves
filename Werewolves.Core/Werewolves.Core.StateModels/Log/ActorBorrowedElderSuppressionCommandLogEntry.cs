...
internal sealed record ActorBorrowedElderSuppressionCommandLogEntry
	: GameLogEntryBase
{
	...
	{
		new ActorBorrowedElderSuppressionCommit(
			PowerIdentity,
			ActorSetupCardId,
	...
	protected override GameLogEntryBase InnerApply(ISessionMutator mutator)
	{
		if (mutator is not IActorSessionMutator actorMutator)
		{
			throw new NotSupportedException(
				"This Session Mutator does not project Actor borrowed Elder suppression.");
		}

		var integrityCommitment =
			actorMutator.ApplyActorBorrowedElderSuppression(this);
	...
	public override string ToString() =>
		"ActorBorrowedElderSuppressionCommand";
}
